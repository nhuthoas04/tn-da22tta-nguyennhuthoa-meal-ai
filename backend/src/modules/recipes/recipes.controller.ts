...
export class RecipesController {
    ...
    getFavorites(
        ...
        return this.recipesService.getFavorites(req.user.id, { page, limit, search, category });
    }
    ...
    adminFindAll(
        ...
        return this.recipesService.findAll({
            page, limit, search, status: status || undefined,
        });
    }
    ...
    reject(@Param('id') id: string, @Body() dto: RejectRecipeDto) {
        return this.recipesService.reject(id, dto.reason);
    }

    @UseGuards(AuthGuard('jwt'), RolesGuard)
    @Roles('admin')
    @Get('admin/moderation/:recipeId/audit')
    getAudit(@Param('recipeId') recipeId: string) {
        return this.recipeModerationService.auditRecipe(recipeId);
    }
    ...
    getMySubmissions(
        ...
        return this.recipesService.getUserSubmissions(req.user.id, { page, limit, status });
    }
